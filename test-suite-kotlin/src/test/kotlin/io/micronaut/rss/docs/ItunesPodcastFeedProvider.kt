...
class ItunesPodcastFeedProvider : RssFeedProvider {
    ...
    @SingleResult
    override fun fetch(): Publisher<RssChannel> {
        return Publishers.just(ItunesPodcast.builder()
                ...
                .category(listOf(ItunesPodcastCategory.SPORTS_AND_RECREATION_OUTDOOR.categories))
                .explicit(false)
    ...
    @SingleResult
    override fun fetchById(id: Serializable?): Publisher<RssChannel> = Publishers.empty()
}
// end::class[]
