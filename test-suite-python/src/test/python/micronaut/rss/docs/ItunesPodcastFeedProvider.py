...
from micronaut.rss import RssChannel, RssChannelImage, RssFeedProvider, RssItemEnclosure
from micronaut.rss.itunespodcast import (
    ItunesPodcast,
    ItunesPodcastCategory,
    ItunesPodcastEpisode,
    ItunesPodcastEpisodeType,
    ItunesPodcastOwner,
    ItunesPodcastType,
)
...
# tag::class[]
@Singleton
class ItunesPodcastFeedProvider(RssFeedProvider):
    ...
    def fetch(self) -> Publisher[RssChannel]:
        return Publishers.just(ItunesPodcast.builder()
                ...
                .category([ItunesPodcastCategory.SPORTS_AND_RECREATION_OUTDOOR.getCategories()])
                .explicit(False)
