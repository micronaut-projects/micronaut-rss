...
class ItunesPodcastFeedProviderTest {
    ...
    @Test
    void theFeedControllerRendersThePodcastWithTheItunesTags() {
        String rss = client.toBlocking().retrieve(HttpRequest.GET("/feed"));
        ...
        assertEquals(9, rss.split("<item>", -1).length - 1);
    }
}
